...
class RenewableEnergy:
    ...
    def export_power(
        ...
        if weather_data.wind:
            if dates:
                data = DataFrame({"Wind Power [GJ/h]": self.wind_power,"Start Date": weather_data.date_lower,"End Date": weather_data.date_upper})
            else:
        ...
        if weather_data.solar:
            if dates:
                data = DataFrame({"Solar Power [kW]": self.solar_power_output,"Start Date": weather_data.date_lower,"End Date": weather_data.date_upper})
            else:
